...
export function Footer({ locale }: FooterProps) {
  ...
  const systemLinks = [
    { label: text.footer.businessOwner, href: `/${locale}/about` },
    { label: text.footer.contact, href: "/contact" },
    { label: text.footer.faq, href: "/legal/faq" },
  ];

  const legalLinks = [
    { label: text.footer.terms, href: "/legal/terms_of_use" },
  ...
  const adsLink = [{ label: text.footer.ads, href: "/legal/ads" }];

  const historyLink = [
    { label: text.footer.history, href: "/legal/revision_history" },
  ];
