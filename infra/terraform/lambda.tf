...
# ==========================================
# 4. shotrip-prod-cognitouser-delete
# ==========================================
resource "aws_lambda_function" "delete_cognitouser" {
  function_name = "shotrip-prod-cognitouser-delete"
  role          = aws_iam_role.backend_role.arn
...
# ==========================================
# 11. shotrip-prod-dynamodbuser-delete
# ==========================================
resource "aws_lambda_function" "delete_dynamodbuser" {
  function_name = "shotrip-prod-dynamodbuser-delete"
  role          = aws_iam_role.backend_role.arn
